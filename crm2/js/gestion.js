...
function completarEtiqueta(element,index,arr){
  ...
  document.getElementById('lbl_eliminar').innerHTML ="¿Desea eliminar el id gestión? <b>" + id_gestion + "</b>";
...
function completarFormulario(element,index,arr){
  ...
  var comentarios = element.nombre_comentarios;
  document.getElementById('txt_comentarios').value = id_comentarios;
